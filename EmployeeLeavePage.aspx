<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeLeavePage.aspx.cs" Inherits="LeaveManagementSystem.EmployeeLeavePage" %>
...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-brand" href="#" style="font-size:large">
        Leave Management System / Employee Leave
    </div>
     </div>
                ...
                <iv class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3 mb-4">
                      <!--  <div class="line"></div> <small class="or text-center">Or</small>
                        <div class="line"></div> -->
                        <h3 class="text-center font-weight-bold">Please enter your Leave details below and click "Submit Leave"
                        </h3>
                    </div>
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input class="mb-4" type="text" name="startDate" placeholder="Enter your Start Date"> 
                    </div>

                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">End Date</h6>
                        </label> <input type="text" name="endDate" placeholder="Enter your End Date"> 
                    </div>
                   
                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">Reason</h6>
                        </label> <input type="text" name="reason" placeholder="Enter your Reason"> 
                    </div>
                    ...
                    <div class="row mb-3 px-3"> <!--<button type="submit" class="btn btn-blue text-center">Login</button> -->
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-blue text-center"
                            Text="Submit Leave" OnClick="Button1_Click1"></asp:Button>
                    </div>      

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="LeaveManagementSystem.AdminPage" %>
...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-brand" href="#" style="font-size:large">
        Leave Management System / Admin Page
    </div>
     </div>
    ...
    <div class="card card0 border-0">
                ...
                <iv class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3 mb-4">
                      <!--  <div class="line"></div> <small class="or text-center">Or</small>
                        <div class="line"></div> -->
                        <h3 class="text-center font-weight-bold">Please enter your Leave details below and click "Approve Leave"
                        </h3>
                    </div>
                    ...
                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">Comment</h6>
                        </label> <input type="text" name="Comment" placeholder="Enter your Comment"> 
                    </div>
                   
                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">ID as seen at the employee leave list!</h6>
                        </label> <input type="text" name="ID" placeholder="Enter Employee ID"> 
                         <br />
                    </div>
            ...
            <asp:ListItem>Pending</asp:ListItem>
                    ...
                    <div class="row mb-3 px-3"> <!--<button type="submit" class="btn btn-blue text-center">Login</button> -->
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-blue text-center"
                            Text="Approve Leave" OnClick="Button1_Click1"></asp:Button>
                    </div>      
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="leaveStatus" HeaderText="leave Status" SortExpression="leaveStatus"></asp:BoundField>
            </Columns>

        </asp:GridView>
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:LeaveDatabaseConnectionString3 %>" ProviderName="<%$ ConnectionStrings:LeaveDatabaseConnectionString3.ProviderName %>" SelectCommand="SELECT * FROM [Employee]"></asp:SqlDataSource>
